    ...
    return (
        <section>
            <div className={'flex justify-center'}>
                <button onClick={() => navigate('order-summary')} className={'bg-pink-500 text-white rounded-[4px] mt-4 p-2 w-[250px]'}>ORDER NOW</button>
            </div>

            <div className="App p-4 flex flex-col justify-center items-center">
                <h1 contentEditable={true} className={'text-center text-3xl mb-6'}>LOGIN</h1>
